...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`dfsdfqsd`}</title>

        <meta
          name="description"
          content="Welcome to dfsdfqsd - Your comprehensive HR Management system. Manage employee data, track time, plan vacations, process payrolls, and conduct performance evaluations all in one central place."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjk0NzAwMTIyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to dfsdfqsd - Your comprehensive HR Management system. Manage employee data, track time, plan vacations, process payrolls, and conduct performance evaluations all in one central place.`}
            </Text>
            <Box
